...
class EditController extends Controller
{
    ...
    public function detailPengurus($uuid)
    {
        $data =
            [
                'detail' => $this->userRepository->findPengurusByUuid($uuid),
        ...
        try {
            if ($data->hasFile('lampiran')) {
                ...
                $setData = [
                    ...
                    'id_anak' => $anak->id,
                    'kiri_1' => $data->kiri_nilai1 ? $data->kiri_nilai1 : null,
                    'kiri_2' => $data->kiri_nilai2 ? $data->kiri_nilai2 : null,
                    'kiri_3' => $data->kiri_nilai3 ? $data->kiri_nilai3 : null,
                    'kiri_4' => $data->kiri_nilai4 ? $data->kiri_nilai4 : null,
                    'kiri_5' => $data->kiri_nilai5 ? $data->kiri_nilai5 : null,
                    'kanan_1' => $data->kanan_nilai1 ? $data->kanan_nilai1 : null,
                    'kanan_2' => $data->kanan_nilai2 ? $data->kanan_nilai2 : null,
                    'kanan_3' => $data->kanan_nilai3 ? $data->kanan_nilai3 : null,
                    'kanan_4' => $data->kanan_nilai4 ? $data->kanan_nilai4 : null,
                    'kanan_5' => $data->kanan_nilai5 ? $data->kanan_nilai5 : null,
                    'binaural_1' => $data->binaural_nilai1 ? $data->binaural_nilai1 : null,
                    'binaural_2' => $data->binaural_nilai2 ? $data->binaural_nilai2 : null,
                    'binaural_3' => $data->binaural_nilai3 ? $data->binaural_nilai3 : null,
                    'binaural_4' => $data->binaural_nilai4 ? $data->binaural_nilai4 : null,
                    'binaural_5' => $data->binaural_nilai5 ? $data->binaural_nilai5 : null,
