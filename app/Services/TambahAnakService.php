...
class TambahAnakService
{
    ...
    public function setFirstData($data)
    {
        ...
        if (is_array($data->file('lampiran')) || is_object($data->file('lampiran'))) {
            ...
            foreach ($lampiranFiles as $lampiran) {
                $namaLampiranBaru = $data->nama_lengkap . '_' . random_int(1, 999) . '_' . $lampiran->getClientOriginalName();
    ...
    public function setHasilTest($data)
    {
        ...
        $setData = [
            ...
            'id_anak' => $anak->id,
            'kiri_1' => $data->kiri_nilai1,
            'kiri_2' => $data->kiri_nilai2,
            'kiri_3' => $data->kiri_nilai3,
            'kiri_4' => $data->kiri_nilai4,
            'kiri_5' => $data->kiri_nilai5,
            'kanan_1' => $data->kanan_nilai1,
            'kanan_2' => $data->kanan_nilai2,
            'kanan_3' => $data->kanan_nilai3,
            'kanan_4' => $data->kanan_nilai4,
            'kanan_5' => $data->kanan_nilai5,
            'binaural_1' => $data->binaural_nilai1,
            'binaural_2' => $data->binaural_nilai2,
            'binaural_3' => $data->binaural_nilai3,
            'binaural_4' => $data->binaural_nilai4,
            'binaural_5' => $data->binaural_nilai5,
            'path_file_hasil_test' => $path,
            'nama_file_hasil_test' => $lampiran,
            'tgl_pemeriksaan' => $data->tgl_pemeriksaan,
            'user_update' => Auth::user()->nama
