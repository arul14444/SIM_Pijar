document.getElementById('tambahHasilPemeriksaan').addEventListener('submit', function(event) {
...
function tambahKegiatan(formData) {
    ...
    .then(data => {
        ...
        if (data.success) {
            document.getElementById('tambahHasilPemeriksaan').reset();
...
function confirmDelete(uuid) {
    ...
    if (confirm('Apakah Anda yakin ingin menghapus data kegiatan '+name+'?')) {
