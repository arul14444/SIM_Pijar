<div class="row text-center">
    <div class="col-md-2 d-flex justify-content-end align-items-center">
        {{-- <img src="{{ asset('asset/logoYayasan3.png') }}"  width="10%" height="auto" class="me-2"> --}}
    </div>    
    <div class="col-md-9">
        ...
        <div class="mx-auto" style="font-size: 10px;">
            <b>Sekretariat: Jl. K.A. Gringsing 8, RT/RW: 05/01, Pondok Mulyo, Gergunung, Klaten Utara, Klaten, Jateng. 57434</b><br>
            <b>Phone: 081351819928, e-mail: pijarmutiarabangsa@gmail.com</b>
        </div>
